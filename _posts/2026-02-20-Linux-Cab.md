...
- to open vpx your need to double click the .VPX table file. but we need to associate it 1st. [VPX File Association & Icon Setup on Ubuntu](https://github.com/MajorFrenchy/MajorFrenchy.github.io/blob/main/_posts/guides/vpx-file-association-ubuntu.md)
<img src="https://github.com/MajorFrenchy/MajorFrenchy.github.io/blob/main/Screenshots/linux-cab/vpx-icon.jpg" 
     width="75%"
     alt="Screenshot"> <br>
     <h1>As you can see now the VPX table has a picture</h1>
  <br>
