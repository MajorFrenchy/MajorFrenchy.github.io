...
- to open vpx your need to double click the .VPX table file. but we need to associate it 1st. [VPX File Association Guide](https://majorfrenchy.github.io/guides/vpx-file-association-ubuntu)
