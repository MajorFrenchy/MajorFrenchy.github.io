...
LiveUI is the new F12 feature in 10.8.1. It is designed to be a fully graphical interface to manage monitor setup for Playfield, Backglass, and ScoreView. This is not working 100% on Linux yet, so you may have to manually adjust values in `VPinballX.ini`.
...
<br>
You can access the menu with F12 and select the option you want to adjust.

Most commonly used settings <br>
- Playfield ( Display )
- Backglass ( Display ) 
- Scoreview ( Display ) DMD
- Point of View ( Point of View ) / change the table view layout
...
- Save `VPinballX_BGFX` in the `home/user/VPX` directory (extract all files into `VPX`).
- Save your tables in `home/user/VPX/tables`.
- To open VPX, you need to double-click a `.vpx` table file, but you need to associate the file type first.

[VPX File Association & Icon Setup on Ubuntu](https://github.com/MajorFrenchy/MajorFrenchy.github.io/blob/main/_posts/guides/vpx-file-association-ubuntu.md)
-    
 <br>
<img src="https://github.com/MajorFrenchy/MajorFrenchy.github.io/blob/main/Screenshots/linux-cab/vpx-icon.jpg" 
     width="75%"
     alt="Screenshot"> <br>
     # As you can see, the VPX table now has an icon preview.
  <br>
